...
<html>
  <head>
    ...
    <title>My JSP 'DoProductWin.jsp' starting page</title>
  ...
  <body>
	...
	PageModel<Products> pageModel=dao.queryProducts(Integer.parseInt(currentPage), 2);
	request.setAttribute("pageModel", pageModel);
	request.getRequestDispatcher("ProductWin.jsp").forward(request,response);
    %>
  </body>
</html>
